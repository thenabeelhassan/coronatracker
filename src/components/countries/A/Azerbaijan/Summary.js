...
export const Azerbaijan = () => {
    ...
    let Azerbaijan = {country: 'Waiting ...', cases: 'Waiting ...', deaths: 'Waiting ...', flag: '...'}
    const [Summary, setSummary] = useState({Azerbaijan})
        ...
        >
            ...
            >
                ...
                <button
                    ...
                    onClick = { () => {
                        document.getElementById('azeHist').style.display = 'block'
